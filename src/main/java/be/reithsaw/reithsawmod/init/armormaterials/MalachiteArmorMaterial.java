package be.reithsaw.reithsawmod.init.armormaterials;
...
public class MalachiteArmorMaterial implements ArmorMaterial
{
    public static final MalachiteArmorMaterial INSTANCE = new MalachiteArmorMaterial();

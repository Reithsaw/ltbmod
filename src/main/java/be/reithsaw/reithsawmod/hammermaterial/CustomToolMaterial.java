package be.reithsaw.reithsawmod.hammermaterial;
...
public class CustomToolMaterial implements ToolMaterial {
    ...
    public static CustomToolMaterial from(HammerData data) {
        return new CustomToolMaterial(
                ...
                data.getBlockBreakSpeed() == 0 ? 3 : data.getBlockBreakSpeed(),
                (data.getDurability() == 0 ? 2 : data.getDurability()) * REITHSAWMOD.CONFIG.durabilityModifier,
